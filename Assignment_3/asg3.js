...
function addActionsForHTMLUI() {
  ...
  // Button Events
  document.getElementById('on_animLegs').onclick = function() { g_yellowAnimation = true; };
  document.getElementById('off_animLegs').onclick = function() { g_yellowAnimation = false; };
  document.getElementById('on_animTail').onclick = function() { g_magentaAnimation = true; };
  document.getElementById('off_animTail').onclick = function() { g_magentaAnimation = false; };
...
function updateAnimationAngles() {
  if (g_yellowAnimation) {
    g_tailAngleX = (45*Math.sin(g_seconds));
  }
  if (g_magentaAnimation) {
    g_tailAngleY = (45*Math.sin(3*g_seconds));
  }
  // if (g_legsAnimation) {
...
function renderScene() {
  ...
  leftArm.matrix.rotate(-g_tailAngleX, 0, 0, 1);
  ...
  box.matrix.rotate(g_tailAngleY, 0, 0, 1);
